...
== Description ==
**THIS PLUGIN WILL NOT BE UPDATE ANYMORE, PLEASE USE MY NEW PLUGN [ULTIMATE WP QUERY SEARCH QUERY](http://wordpress.org/plugins/ultimate-wp-query-search-filter/) INSTEAD**
